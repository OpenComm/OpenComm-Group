...
public class AudioSS {
	...
	private double itdMS; // interaural time delay in millisecond
	...
	private void setITD() {
		...
		this.itdMS = 1000 * AudioSS.headRad/AudioSS.speedSound * (theta + Math.sin(theta));
	...
	private void setBalance() {
		...
		double dd = (this.itdMS/1000 * AudioSS.speedSound);
		// multiply dd by 4
