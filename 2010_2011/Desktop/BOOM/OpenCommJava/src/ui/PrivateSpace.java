...
public class PrivateSpace extends Tab1 {
	...
	public PrivateSpace(PApplet theParent, ArrayList<Person> group, int x,
			ControlP5 /* Han-Wei: Feb 26 Bug! Correct this */theControlP5, int num) {
		...
		this.num = num;
		privateRoom = new Space(parent, MainWindow.mainh - 120,
				MainWindow.mainw - 200, 222, 50, -60, -70, controlP5, num);
	...
	public void draw(PApplet parent) {
		...
		if (number == 0)
			// parent.fill(18,64,170,200);
			parent.fill(63, 109, 215, 200);// NORA: edited this 3/7
		else
			// (number == 1) // NORA: edited this 3/7
			// parent.fill(64,18,176,200);
			parent.fill(114, 68, 226, 200);// NORA: edited this 3/7
		...
		// NORA: edited this 3/7
		if (number == 0)
			// parent.fill(63,109,215,200);
			parent.fill(93, 139, 245, 255);
		else
			// parent.fill(114,68,226,200);
			parent.fill(144, 98, 256, 255);
		parent.rect(0, tabh, w, h); // NORA - corrected this 3/6

		// draw the background of the controller.

		// NORA commented out for now 3/7
		/*
		 * if(getIsInside()) { parent.fill(150); } else { parent.fill(100); }
		 */
	...
	public void mouseEvent(MouseEvent event) {
		...
		case MouseEvent.MOUSE_CLICKED:
			if (!privateViewScreen.isOpen() && getIsInside()) {
				...
				MainWindow.curr = privateRoom;
				if (this.num == 1) {
					MainWindow.currPeople = MainWindow.people1;
				} else
					MainWindow.currPeople = MainWindow.people2;
				...
				privateViewScreen.setIsOpen(open);
				privateRoom.setPeopleVisible(open);
				MainWindow.curr = MainWindow.mainSpace;
				MainWindow.currPeople = MainWindow.people;
			}
			break;
