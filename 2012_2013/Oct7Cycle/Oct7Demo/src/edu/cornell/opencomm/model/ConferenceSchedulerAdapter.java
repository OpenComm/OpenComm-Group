...
public class ConferenceSchedulerAdapter extends BaseExpandableListAdapter {
	...
	public ConferenceSchedulerAdapter(Context context,
			ArrayList<Conference> groups, boolean conference_is_happening_now) {
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		if (view == null) {
			...
			view = infalInflater.inflate(R.layout.conference_details_layout,
					null);
		}
		@SuppressWarnings("unused")
		Conference conference = (Conference) getGroup(groupPosition);
		// TODO Spandana - Assign correct information from conference object to
		// elements in view
		return view;
	}
	...
	/**
	 * Customize the view from conference information, and add functionality to
	 * buttons
	 */
	public void customizeView(Conference conference, View view) {
		TextView conference_title = (TextView) view
				.findViewById(R.id.conference_title);
		conference_title.setText(conference.getConferenceTitle());
		TextView conference_attendees = (TextView) view
		...
		if (conference_is_happening_now) {
			...
			ImageView go_to_conference_button = (ImageView) view
					.findViewById(R.id.go_to_conference_button);
