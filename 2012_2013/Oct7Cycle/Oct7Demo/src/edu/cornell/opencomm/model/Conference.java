...
public class Conference {
	...
	public Conference(String conferenceTitle, Calendar startDateAndTime,
			Calendar endDateAndTime, String reoccurrence, String notes,
	...
	public String getAttendeesSummary() {
		/*
		 * String attendees_summary = ""; for (User user : attendees){
		 * attendees_summary << "" }
		 */
		return null;
	}
	...
	public String getNumberMonthAndDay() {
		return startDateAndTime.get(Calendar.MONTH) + "/"
				+ startDateAndTime.get(Calendar.DATE);
	}

	/** Return time in example form of 12:00pm */
	public String getTimeHourAndMinute() {
		return startDateAndTime.get(Calendar.HOUR) + ":"
				+ startDateAndTime.get(Calendar.MINUTE)
				+ (startDateAndTime.get(Calendar.AM_PM) == 1 ? "pm" : "am");
	}
}
