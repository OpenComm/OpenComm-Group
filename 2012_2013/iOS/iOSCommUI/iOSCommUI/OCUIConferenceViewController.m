//
//  OCUIConferenceViewController.m
//  iOSCommUI
//
...
#import "OCUIConferenceViewController.h"
#import "OCUIConferenceTableCell.h"
#import "HappeningNowConferenceCell.h"
@interface OCUIConferenceViewController ()

@end

@implementation OCUIConferenceViewController{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    OCUIConferenceTableCell *cell;

      
    if (indexPath.section==0){
        static NSString *simpleTableIdentifier = @"HappeningNowTableCell";
        
        HappeningNowConferenceCell *cell = (HappeningNowConferenceCell *)[tableView dequeueReusableCellWithIdentifier:simpleTableIdentifier];
        if (cell == nil)
        {
       ...
       // cell.imageView.bounds = CGRectMake(0, 0, 25, 55);
        ...
        cell = (OCUIConferenceTableCell *)[tableView dequeueReusableCellWithIdentifier:CellIdentifier2];
        if (cell == nil)
        {
