...
public class ConferencePacket extends Packet {
	...
	public ConferencePacket(String name, Calendar startDate, Calendar endDate,
			String inviter, String recurrence, String description,
	...
	public boolean equals(Object o) {
		...
		return false;
		//Note: design issue - should a user be able to create a conference that is
		//exactly identical to one they have already created?  How do we handle that?
		//On this end, they will be processed and stored as two unique conferences and
		//will not fail the equals test
