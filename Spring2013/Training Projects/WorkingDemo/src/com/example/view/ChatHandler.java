...
public class ChatHandler {
	...
	public void invite(String user){
		chat.invite(user + "@cuopencomm", "Let's chat!");
	}
	...
	public ArrayList<String> buddyList(){
	...
	public ArrayList<String> participantsList(){
		...
		try {
			Collection<Occupant> occupantEntries = chat.getParticipants();
			for (Occupant occupant : occupantEntries) {
			    participants.add(occupant.getJid());
			}
			return participants;
		} catch (XMPPException e) {
			return null;
