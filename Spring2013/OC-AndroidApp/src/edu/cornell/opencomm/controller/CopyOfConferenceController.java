...
import edu.cornell.opencomm.view.CopyOfConferenceView;

@SuppressWarnings("unused")
public class CopyOfConferenceController {
	
	private CopyOfConferenceView view;
	...
	public CopyOfConferenceController(CopyOfConferenceView view, ConferenceDataModel model) {
	...
	public CopyOfConferenceController(ConferenceDataModel conf) {
