...
public class User {
	...
	MUCBuddy mucbuddy; // mucbuddy instance of this user, used for audio
	...
	public User(String username, String nickname, int image){
        ...
        this.mucbuddy = new MUCBuddy(this.username, LoginController.xmppConnection);
        if (image == 0){
	...
	public MUCBuddy getMUCBuddy() {
		return this.mucbuddy;
	} // end getMUCBuddy method
