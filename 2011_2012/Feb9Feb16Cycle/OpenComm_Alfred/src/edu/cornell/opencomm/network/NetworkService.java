...
public class NetworkService {
    ...
    public NetworkService(String host, int port) throws XMPPException {
        ...
        /* MultiUserChat.addInvitationListener(xmppConn, */new InvitationListener() {
            ...
            /**
             * Automagically called when this client receives an invitation to
             * join a MUC
             */
            @Override
            public void invitationReceived(Connection connection, String room,
                ...
                /*
                 * Object[] members = null; String nickname; try { members=
                 * muc.getParticipants().toArray(); } catch (XMPPException e) {
                 * Log.v("NetworkService",
                 * "Cannot retrieve participants from server."); } // Get the
                 * user/occupant object of the inviter if(members!=null){
                 * Occupant occupantInviter = null; for(Object o : members){
                 * String jid = ((Occupant)o).getJid(); if(jid==inviter)
                 * occupantInviter = (Occupant)o; }
                 */
                /*
                 * Get information from person's profile such as: name, phone,
                 * email. For now, we do not have profile information
                 */
             ...
             * 
             * //TODO: Trigger update to the view! //TODO: call
             * InvitationController.accept, or InvitationController.decline
             * 
             * //DEBUG Log.v("InvitationController",
             * "invitationReceived - Invitation " + "received from: " + inviter
             * + " to join room: " + room);
             */
            // }
    ...
    public static String printXMPPError(XMPPException e) {
        ...
        if (e != null && e.getXMPPError() != null) {
            ...
            temp += (e.getXMPPError().getMessage() != null ? " - "
