...
public class Network {
    ...
    public static final String REQUEST_INVITE = packageName + cycleName
            + ".REQUEST_INVITE";
    public static final String REQUEST_KICKOUT = packageName + cycleName
            + ".REQUEST_KICKOUT";
    public static final String REQUEST_DELETE = packageName + cycleName
            + ".REQUEST_DELETE";

    // INVITATION AND KICKOUT REQUEST REJECTION MESSAGES
    public static final String REJECT_INVITE = packageName + cycleName
            + ".REJECT_INVITE";
    public static final String REJECT_KICKOUT = packageName + cycleName
            + ".REJECT_KICKOUT";
