...
public class Values {
    ...
    // Time
    public static int pressAndHold = 200; // amount of time for a touch to be
                                          // considered a long press

    // Menu options
    public static CharSequence[] userviewMenu = { "Delete User", "Cancel" }; // after
                                                                             // longpressing
                                                                             // a
                                                                             // user
                                                                             // icon
    public static CharSequence[] emptyspaceMenu = { "Add Users",
            "Delete Users", "Leave Conference", "Cancel" }; // after
                                                            // longpressing the
                                                            // empty space in a
                                                            // spaceview
    public static CharSequence[] privatespaceiconMenu = { "Go to", "Leave",
            "Cancel" };
    ...
    // Section heights
    public static int actionBarH = 72; // Upper strip at top that says
                                       // "OpenComm"
    public static int spaceViewH = 350; // Area where user icons are shown
    public static int bottomBarH = 138; // Bottom strip that holds private space
                                        // icons
    public static int voice_imageSpaceH = 20; // Space between you_image and the
                                              // bottom bar
    ...
    // Buddylist
    public static CharSequence[] _options = { "Rahul", "Nora", "Najla", "Risa",
            "Justin", "Crystal" };
