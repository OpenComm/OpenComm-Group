...
public class NotificationView {
    ...
    public void launch(String tip) {
        ...
        if (tip.equals("admin")) {
            ...
            Log.d(TAG,
                    "Rendering admin tip with text : "
                            + context.getString(R.string.admin_tip));

        } else if (tip.equals("sidechat")) {
            textView.setText(context.getString(R.string.sidechat_tip));
            Log.d(TAG,
                    "Rendering sidechat tip with text : "
                            + context.getString(R.string.sidechat_tip));
        } else {
    ...
    public void launch(String nickname, String tip) {
        ...
        if (tip.equals("adduser")) {
            textView.setText(nickname + " "
                    + context.getString(R.string.adduser_tip));
            Log.d(TAG,
                    "Rendering add user tip with text : "
                            + context.getString(R.string.adduser_tip));
        } else if (tip.equals("deleteuser")) {
            textView.setText(nickname + " "
                    + context.getString(R.string.deleteuser_tip));
            Log.d(TAG,
                    "Rendering delete user tip with text : "
                            + context.getString(R.string.deleteuser_tip));
        } else {
            textView.setText("unknown tip");
            Log.d(TAG, "Rendering unknown tip");
