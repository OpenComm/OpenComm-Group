...
public class InvitationView {
    ...
    public InvitationView(LayoutInflater inflater, Invitation invitation,
            InvitationController inviteController) {
        this.inflater = inflater;
        this.invitation = invitation;
    ...
    /**
     * Set the information on the invite 1) If a moderator request - user image
     * and profile info set to that of the invitee's Message should say
     * "requester requests to invite invitee to this chat" 2) Otherwise, set to
     * info of the requester Message should say
     * "Requester would like to invite you to a chat"
     */
    public void setInvitationInfo(User requester, User invitee,
        ...
        if (invitationLayout != null) {
            userImage = (ImageView) invitationLayout
                    .findViewById(R.id.iconImage);
            confTitle = (TextView) invitationLayout
                    .findViewById(R.id.textViewConfTitle);
            bigNameTitle = (TextView) invitationLayout
                    .findViewById(R.id.textViewHeader);
            userProfInfo = (TextView) invitationLayout
            ...
            if (isModeratorRequest) {
                ...
                confMessage = confRequesterName + " invited " + inviteeName
                        + " to a chat.";
    ...
    /**
     * Use this version of setInvitationInfo if you wish to input the String
     * values instead of the user objects. This version only for if you received
     * an invitation and are not a moderator.
     */
    public void setInvitationInfo(int imageDrawableInt, String inviterNickname,
            String inviterPhone, String inviterEmail) {
        if (invitationLayout != null) {
            ImageView userImage = (ImageView) invitationLayout
                    .findViewById(R.id.iconImage);
            TextView confTitle = (TextView) invitationLayout
                    .findViewById(R.id.textViewConfTitle);
            TextView bigNameTitle = (TextView) invitationLayout
                    .findViewById(R.id.textViewHeader);
            TextView userProfInfo = (TextView) invitationLayout
                    .findViewById(R.id.textViewInfo);

            // int userImageDrawable =
            // Values.default_user_image;//imageDrawableInt;
    ...
    /*
     * public void setUserImage(User user){ ImageView userImage = null;
     * if(invitationLayout != null) { userImage = (ImageView)
     * invitationLayout.findViewById(R.id.iconImage); int image =
     * user.getImage();
     * userImage.setImageDrawable(MainApplication.screen.getActivity
     ...
     *            - true if a invite request to a moderator, false if is a
     *            simple invite request
     */
    /*
     * public void setConferenceTitle(User requester, User invitee, boolean
     * moderatorRequest){ String message; String requesterName =
     * requester.getNickname(); if(invitee==MainApplication.user_primary){
     * message = requesterName + " would like to invite you to a chat."; } else
     * { String inviteeName = invitee.getNickname(); message = requesterName +
     * " would like to invite " + inviteeName + " to a chat."; } TextView
     * current = null; if(invitationLayout != null){ current = (TextView)
     * invitationLayout.findViewById(R.id.textViewConfTitle);
     ...
     */
    public void launch() {
        // Log.v(LOG_TAG, "Inflater is null = " + (inflater==null) +
        // ", and invationLayout is null = " + (invitationLayout==null));
