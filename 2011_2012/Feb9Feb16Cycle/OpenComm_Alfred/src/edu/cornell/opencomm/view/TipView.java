...
public class TipView {
    ...
    private void initEventsAndProperties() {
        ...
        // property
        if (inflater != null) {
            View tipViewFromInflater = inflater.inflate(R.layout.tip_layout,
                    null);
    ...
    public ImageButton getAcceptImageButton() {
        ...
        if (tiplayout != null) {
            acceptButton = (ImageButton) tiplayout
    ...
    public void launch() {
        if (inflater != null && tiplayout != null) {
            window = new PopupWindow(tiplayout, Values.screenW, Values.screenH,
                    true);
            window.showAtLocation(tiplayout, 0, 1, 1);
            tiplayout.setOnClickListener(onClickListener);
        } else {
            Log.v(LOG_TAG, "Cannot launch tip view as inflater layout is null");
        }
    }
