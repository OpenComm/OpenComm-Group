...
public class SpaceViewController {
     ...
     * 
     * @param newSpace
     *            - the new space to change the spaceView to
     */
    public void changeSpace(Space newSpace) {
        Log.v("SpaceViewController", "changeSpace() from "
                + MainApplication.screen.getSpace() + " to " + newSpace);
        ...
        if (!MainApplication.screen.getSpace().getEntered()) {
            ...
            s.setEntered(true);
            /*
             * If you are the owner and it is your first time entering the
             * space, then open the admin tip popup
             */
            ...
            /*
             * If you are not the owner of the space, and it is your first time
             * entering the space, then open the tip popup
             */
            else {
                LayoutInflater inflater = (LayoutInflater) m
                        .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        ...
        Log.v("SpaceViewController", "changeSpace() successfuly to "
