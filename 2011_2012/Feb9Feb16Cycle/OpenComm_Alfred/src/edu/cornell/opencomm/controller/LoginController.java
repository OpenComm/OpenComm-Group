...
public class LoginController {
    ...
    public void handleLoginButtonClick(EditText usernameEdit,
            EditText passwordEdit) {
        loginView.getLoginOverlay().setVisibility(View.VISIBLE);

        ProgressDialog
                .show(this.loginView, "", "Loading. Please wait...", true);

        if (D)
            Log.d(LOG_TAG, "handleLogin: Attempt log in");
        ...
        try {
            if (D) {
                ...
                // log in using the username and password inputted by primary
                // user
        ...
        i.putExtra(Network.KEY_USERNAME, (D ? Network.DEBUG_USERNAME
         ...
         * .getSystemService(Context.LAYOUT_INFLATER_SERVICE); DashboardView
         * dashboardView = new DashboardView(inflater); loginView.finish();
