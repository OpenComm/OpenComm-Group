...
/**
 * An instance of this class is a space controller for each space (main space or
 * private space), such as adding/deleting people from a space.
 * 
...
public class SpaceController {
    ...
    public SpaceController(Space space, SpaceView view) {
        ...
        this.view = view;
        SpaceController.notification_View = new NotificationView(
                view.getContext());
    ...
    public void deleteSpace() {
         ...
         * if(!u.getUsername().equals(MainApplication
         * .user_primary.getUsername()))
         * this.space.getKickoutController().kickoutUser(u,
         * Network.DEFAULT_KICKOUT); } catch (XMPPException e) { // TODO
         * Auto-generated catch block e.printStackTrace(); } }
         * this.space.getMUC().leave();
         */
        // The following line could cause an infinite loop. Better to just leave
        // as above.
