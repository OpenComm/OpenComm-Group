...
/**
 * When a user press and hold an icon of the mainscreen, this controller is
 * invoked. It displays a dialog menu.
 * 
 * @author - rahularora
 */
public class UserIconMenuController {
    ...
    /**
     * Show a menu after long-pressing on a user icon (UserView) Menu options
     * are: Delete User, Cancel
     */
    public static void showIconMenu(UserView uv) {
        ...
        builder.setItems(Values.userviewMenu,
                        ...
                        if (Values.userviewMenu[item].equals("Delete User")) {
                            ...
                            try {
                                spaceView
                                        ...
                                        .kickoutUser(userView.getPerson(),
                                                "Because you should leave");
                            } catch (XMPPException e) {
                                Log.d("UserIconMenuController",
                                        "Couldn't kick out user "
                                                + userView.getPerson()
                                                + " from space "
                                                + spaceView.getSpace()
                                                        .getRoomID());
