...
public class DashboardController {
    /*
     * Debugging private static String TAG = "Controller.DashboardController";
    ...
    public void handleStartConferenceButtonClicked() {
        ...
        ProgressDialog.show(this.dashboardView, "", "Loading. Please wait...",
                true);
        String username = this.dashboardView.getIntent().getStringExtra(
