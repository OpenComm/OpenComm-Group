...
/**
 * When a user press and hold a SideChat Icon, this controller is invoked. It
...
public class SideChatIconMenuController {
    ...
    public SideChatIconMenuController(Context context,
            PrivateSpaceIconView privateSpaceIconView) {
    ...
    public void showSideChatMenu() {
        ...
        builder.setItems(Values.privatespaceiconMenu,
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        if (Values.privatespaceiconMenu[item].equals("Go to")) {
                            ...
                            MainApplication.screen.getSpaceViewController()
                                    .changeSpace(
                                            privateSpaceIconView.getSpace());
                        } else if (Values.privatespaceiconMenu[item]
                                .equals("Leave")) {
                            // Do something if user clicks on Leave Chat
                            // delete the icon and the room
                            Space space = privateSpaceIconView.getSpace();
                            space.getParticipantController().leaveSpace(
        ...
        builder.setTitle("Side Menu").create();
