...
public final class MainApplication extends Activity {
    ...
    public View.OnKeyListener onKeyListener = new View.OnKeyListener() {
        ...
        public boolean onKey(View v, int keyCode, KeyEvent event) {
            ...
            case KeyEvent.KEYCODE_N: {
                ...
                try {
                    (Space.getMainSpace().getKickoutController()).kickoutUser(
                            debug, "You suck!");
                } catch (XMPPException e) {
            ...
            case KeyEvent.KEYCODE_V: {
                ...
                Space.getMainSpace().getParticipantController()
                        .grantOwnership("opencommsec@jabber.org", false);
                break;
            }
            ...
            case KeyEvent.KEYCODE_J: {
                ...
                /*
                 * ParticipantStatusController psController = new
                 * ParticipantStatusController(mainspace); String test =
                 * "roomname@conference.jabber.org/" + debug1.getNickname();
                 * psController.joined(test);
                 */

                Space.getMainSpace()
                        .getPsController()
                        .joined("roomname@conference.jabber.org/"
                                + debug1.getNickname());
                break;
            }
            ...
            case KeyEvent.KEYCODE_W: {
                ...
                String inviteRequest = "" + Network.REQUEST_INVITE
                        ...
                        + "@reason" + "Because you're a cool cat.";
                ic.receiveInvitationRequest(inviteRequest);
                /*
            ...
            case KeyEvent.KEYCODE_R: {
                ...
                String kickoutRequest = "" + Network.REQUEST_KICKOUT
                        + "@requester" + debug.getUsername() + "@kickee"
                        + MainApplication.user_primary.getUsername()
                        + "@reason" + "Because you didn't give me food.";
                kc.receiveKickoutRequest(kickoutRequest);
                break;
            }
            ...
            public boolean onTouch(View view, MotionEvent evt) {
                ...
                case MotionEvent.ACTION_UP:
                    if (!(screen.getSpace() == Space.getMainSpace())) {
                        MainApplication.screen.getSpaceViewController()
    ...
    public void init_deletePrivateSpace(Space spaceToDelete) {
        if (spaceToDelete.getOwner().getUsername()
                .equals(user_primary.getUsername())
                && spaceToDelete.isMainSpace() == false) {
            spaceToDelete.getMUC().getOccupants();
            // message containing delete request tag, the username of the
            // deleter,
            ...
            Message msg = new Message(Network.REQUEST_DELETE + "@requester"
                    ...
                    + Network.DEFAULT_DELETE, Message.Type.groupchat);
            try {
                spaceToDelete.getMUC().sendMessage(msg);
            } catch (XMPPException e) {
                if (D)
                    Log.d(TAG, "init_deletePrivateSpace - message not sent: "
            ...
            Log.w(TAG,
                    "Cannot delete main private space, or user does not have authority");
        }
    }
        ...
        plus.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Space newSpace = Space.getMainSpace().getSpaceController()
                            .addSpace(Space.getMainSpace().getContext());
