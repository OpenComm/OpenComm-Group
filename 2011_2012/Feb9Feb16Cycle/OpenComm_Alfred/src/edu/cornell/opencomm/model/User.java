...
public class User {
    ...
    static int[] colors = { R.color.blue, R.color.green, R.color.orange,
            R.color.teal, R.color.light_purple, R.color.red, R.color.pink,
            R.color.grass_green, R.color.ocean_blue, R.color.showy_green };
    ...
    public static HashMap<String, User> nickname_to_user = new HashMap<String, User>();
