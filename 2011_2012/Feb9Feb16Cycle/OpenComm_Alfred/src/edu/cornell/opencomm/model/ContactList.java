...
/**
 * A user's contact list. This is a Roster of users for which the network will
 * send the primary user status updates. A user can add and/or delete other
 * users from their contact list.
 * 
 */
public class ContactList {
     ...
     * 
     * @param user
     *            - the JID of the user to be removed (ex:
