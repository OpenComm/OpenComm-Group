...
public class XMPPClientSettings extends Dialog implements android.view.View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        String host = getText(R.id.host) == null || getText(R.id.host).equals("") ? "jabber.org" : getText(R.id.host);
        String port = getText(R.id.port) == null || getText(R.id.port).equals("") ? "5222" : getText(R.id.port);
        //String service = getText(R.id.service) == null || getText(R.id.service).equals("") ? null : getText(R.id.service);
        String username = getText(R.id.userid) == null || getText(R.id.userid).equals("") ? "ocaudio1" : getText(R.id.userid);
        String password = getText(R.id.password) == null || getText(R.id.password).equals("") ? "opencomm" : getText(R.id.password);

        Log.i(XMPPClientLogger.TAG, "[XMPPClientSettings] - " + host + ":" + port + "\t" + username + "\t" + password );
