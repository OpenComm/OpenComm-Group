...
public class JingleIQActionMessages {
	 ...
	 */
	public void sendSessionInitiate(String jidFrom, String jidTo, JingleController buddy){
		Log.i("JingleIQActionMessages", jidFrom + " sending a session initiate to " + jidTo);
	 ...
	 * @param buddy <code>MUCBuddy</code> object to set transport information
	 */
	public void sendSessionAccept(JingleIQPacket incomingIQ, JingleController buddy) {
	...
	public void sendSessionTerminate(String from, String to, String sid, ReasonElementType reason, JingleController buddy){
