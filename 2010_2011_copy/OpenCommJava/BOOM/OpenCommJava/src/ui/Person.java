...
public class Person implements Comparable<Person> {
	...
	public Person(PApplet parent, int index, String imageName,
			String tinyimagename, String name, String ip) {
		...
		tinyimage = parent.loadImage(tinyimagename);
		this.ip = ip;
	...
	// space.selected = null; //is this a problem? what if I release off the
	// window? - Frye
	// break;
	// }
	// }
