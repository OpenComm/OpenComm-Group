...
http://www.anyexample.com/programming/java/java_play_wav_sound_file.xml
	...
	Version 1 Code borrowed to input audio from wave files.'
		Demonstrates example of AudioSS integration in terms of entering and 
		leaving PrivateSpaces.
